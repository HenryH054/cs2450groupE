...
public class UVSimGUI extends javax.swing.JFrame {
    ...
    public int getInputField() {
        try {
            ...
            if (inputText != null) {
                while (!inputText.matches("^-?\\d{1,6}$")) {
                    JOptionPane.showMessageDialog(null, "Invalid number entered!\n" +
                            "Please enter a one to six-digit numerical value or 6 digit instruction.");
                    inputText = inputDialog();
                }
                return Integer.parseInt(inputText);
            }
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(null, "Invalid number entered! 6 digit numbers only.\n\"0\" has been entered\n.");
        }
        return 0;
    }
    ...
    private static String inputDialog() {
        return JOptionPane.showInputDialog("Please enter a one to six-digit numerical value or 6 digit instruction:\n" +
